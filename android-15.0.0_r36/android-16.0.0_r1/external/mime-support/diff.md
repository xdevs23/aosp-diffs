...
index 806821e..f6b8bbf 100644
--- a/Android.bp
+++ b/Android.bp
@@ -27,3 +27,16 @@ java_genrule {
     //    strip comments            normalize whitepace       drop empty lines
     cmd: "awk '{gsub(/#.*$$/,\"\"); $$1=$$1; print;}' $(in) | grep ' ' > $(out)",
 }
+
+java_genrule {
+    name: "debian.mime.types.minimized-alt",
+    visibility: [
+        "//visibility:public",
+    ],
...
+  last_upgrade_date { year: 2025 month: 3 day: 5 }
   license_type: UNENCUMBERED
 }
diff --git a/OWNERS b/OWNERS
index 1c25eeb..5ac8c7b 100644
--- a/OWNERS
+++ b/OWNERS
@@ -1,3 +1,4 @@
 # Bug component: 24949
...
index 8e26dee..5be2c8d 100644
--- a/mime.types
+++ b/mime.types
@@ -642,6 +642,7 @@ image/jp2					jp2 jpg2
...
+image/jxl					jxl
 ...
 image/pcx					pcx
 image/png					png
diff --git a/mime.types-alt b/mime.types-alt
new file mode 100644
index 0000000..9c5afcc
--- /dev/null
+++ b/mime.types-alt
@@ -0,0 +1,2320 @@
+###############################################################################
