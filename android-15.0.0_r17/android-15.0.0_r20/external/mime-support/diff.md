...
index 573b69f..925780a 100644
--- a/METADATA
+++ b/METADATA
@@ -1,17 +1,17 @@
 name: "mime-support"
 description:
-    "Android's copy of the mime.types file from Debian's media-types package."
+    "Android's copy of the mime.types file from Debian's mime-support package."
 
 third_party {
   url {
     type: HOMEPAGE
-    value: "https://salsa.debian.org/debian/media-types"
+    value: "https://salsa.debian.org/debian/mime-support"
   }
   url {
     type: GIT
-    value: "https://salsa.debian.org/debian/media-types/-/blob/master/mime.types"
+    value: "https://salsa.debian.org/debian/mime-support/blob/debian/3.63/mime.types"
   }
-  version: "0cde41f063cf435631dcd1d096cb1c396cdfc315"
-  last_upgrade_date { year: 2024 month: 7 day: 12 }
+  version: "Debian/3.63"
+  last_upgrade_date { year: 2019 month: 10 day: 3 }
   license_type: UNENCUMBERED
 }
diff --git a/mime.types b/mime.types
index 9c5afcc..8e26dee 100644
--- a/mime.types
+++ b/mime.types
@@ -1,16 +1,16 @@
 ###############################################################################
...
@@ -956,78 +238,25 @@ application/vnd.japannet-registration-wakeup
...
@@ -1035,375 +264,86 @@ application/vnd.motorola.flexsuite.gotap
...
@@ -1411,13 +351,10 @@ application/vnd.stardivision.calc						sdc
...
@@ -1428,41 +365,15 @@ application/vnd.sun.xml.math							sxm
...
@@ -1476,99 +387,51 @@ application/vnd.uplanet.list-wbxml
...
@@ -1576,21 +439,41 @@ application/x-graphing-calculator		gcf
...
@@ -1601,7 +484,7 @@ application/x-nwc				nwc
...
@@ -1609,11 +492,15 @@ application/x-rdp				rdp
...
@@ -1623,220 +510,62 @@ application/x-tex-gf				gf
...
+audio/x-realaudio				ra
 ...
 audio/x-sd2					sd2
 audio/x-wav					wav
@@ -1846,7 +575,7 @@ chemical/x-cache				cac cache
...
+chemical/x-cerius				cer
 ...
 chemical/x-cif					cif
@@ -1872,7 +601,7 @@ chemical/x-isostar				istr ist
...
@@ -1880,16 +609,17 @@ chemical/x-mdl-sdfile				sd sdf
...
@@ -1898,91 +628,42 @@ chemical/x-xtel					xtel
 chemical/x-xyz					xyz
...
@@ -1991,330 +672,175 @@ image/x-coreldrawpattern			pat
